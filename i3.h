...
#define I3DRIVER "AFKMud I3 Driver 2.40c"
 ...
 */
#define IPS 2097152 // Maximum incoming packet size: Per protocol specs at https://wotf.org/specs/mudmode.html
#define OPS 262144  // Maximum outgoing packet size: Per protocol specs at https://wotf.org/specs/mudmode.html
...
#define I3FCLOSE(fp) do { if ((fp)) { fclose((fp)); (fp) = NULL; } } while(0)
